...
const RecipesOverviewPage = () => { // Plus besoin de handleNavigate en prop
  ...
  return (
    <section id="recipes-overview-section" className="py-16 px-6 md:px-12 bg-white rounded-xl mx-4 my-6 shadow-lg">
      ...
      <div className="mb-12 p-8 bg-green-50 rounded-lg shadow-md">
        ...
        <button onClick={() => navigate('/generate-recipe')} className="px-6 py-3 bg-green-600 text-white font-semibold rounded-full hover:bg-green-700 transition-colors">Créer une Recette IA</button>
      </div>
      ...
      <div className="mb-12 p-8 bg-purple-50 rounded-lg shadow-md">
        ...
        <button onClick={() => navigate('/generate-recipe')} className="px-6 py-3 bg-purple-600 text-white font-semibold rounded-full hover:bg-purple-700 transition-colors">Rechercher par Ingrédients</button>
      </div>
      ...
      <div className="mb-12 p-8 bg-blue-50 rounded-lg shadow-md">
        ...
        <button onClick={() => navigate('/')} className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-colors">Explorer les Recettes</button>
      </div>
    </section>
  );
};
