    ...
    <section id="profile-page-section" className="py-16 px-6 md:px-12 bg-gray-50 rounded-xl mx-4 my-6 shadow-lg">
      ...
      <div className="max-w-3xl mx-auto p-8 bg-white rounded-2xl shadow-xl border border-gray-200 mb-8 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col space-y-4 w-full md:w-auto">
          ...
          <button onClick={() => navigate('/')} className="flex items-center justify-center md:justify-start px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-full shadow-sm hover:bg-gray-200 transition-colors">
      ...
      {isAdmin && (
        <div className="p-8 bg-blue-100 rounded-lg shadow-md max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <button onClick={() => navigate('/admin/analytics')} className="flex flex-col items-center justify-center p-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition-colors h-24">
                    <BarChartIcon className="h-8 w-8 mb-2"/> Tableau de Bord
                </button>
                <button onClick={() => navigate('/admin/locations')} className="flex flex-col items-center justify-center p-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition-colors h-24">
                    <GlobeIcon className="h-8 w-8 mb-2"/> Localisation
                </button>
                <button onClick={() => navigate('/admin/feature-usage')} className="flex flex-col items-center justify-center p-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition-colors h-24">
