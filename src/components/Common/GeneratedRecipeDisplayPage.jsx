...
const GeneratedRecipeDisplayPage = ({ generatedRecipe, handleNavigate }) => {
  if (!generatedRecipe) {
    return (
      <section className="py-16 px-6 md:px-12 bg-gray-50 rounded-xl mx-4 my-6 shadow-lg text-center text-gray-500">
        ...
        <button onClick={() => handleNavigate('createRecipeForm')} className="mt-4 px-6 py-3 bg-green-600 text-white font-semibold rounded-full hover:bg-green-700 transition-colors">
          Générer une recette
        </button>
      </section>
    );
